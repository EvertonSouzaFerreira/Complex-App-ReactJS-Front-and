  ...
  return (
    <>
      <div className="flex-row my-3 my-md-0">
          ...
          {" "}<span onClick={toggleChat} data-for="chat" data-tip="Chat" className={"mr-2 header-chat-icon " + (appState.unreadChatCount ? "text-danger" : "text-white")}>
